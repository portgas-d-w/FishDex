...
const TECHNIQUE_IMAGES: Record<string, string> = {
  // Mouche — du plus spécifique au général (order matters pour getTechImage)
  'mouche naine':            '/techniques/mouche-naine.png',
  ...
  'nymphe au fil':           '/techniques/nymphe-fil.png',
  'nymphe':                  '/techniques/nymphe-fil.png',
  'mouche':                  '/techniques/mouche.png',
  ...
  'leurre lourd':            '/techniques/leurre-lourd.png',
  'leurre souple':           '/techniques/leurre-souple.png',
  'micro-leurre':            '/techniques/micro-leurre.png',
  'micro leurre':            '/techniques/micro-leurre.png',
  'petit leurre':            '/techniques/petit-leurre.png',
  'drop shot':               '/techniques/drop-shot.png',
  ...
  // Appâts naturels
  'bouillette végétale':     '/techniques/bouillette-vegetale.png',
  'bouillette vegetale':     '/techniques/bouillette-vegetale.png',
  'bouillette spécifique':   '/techniques/bouillette-specifique.png',
  'bouillette specifique':   '/techniques/bouillette-specifique.png',
  'bouillette':              '/techniques/bouillette.png',
  'aliment végétal':         '/techniques/aliment-vegetal.png',
  'aliment vegetal':         '/techniques/aliment-vegetal.png',
  'asticot':                 '/techniques/asticot.png',
  'herbe':                   '/techniques/herbe.png',
  'maïs':                    '/techniques/mais.png',
  'mais':                    '/techniques/mais.png',
  'pain':                    '/techniques/pain.png',
  'pellet esturgeon':        '/techniques/pellet-esturgeon.png',
  'pellet':                  '/techniques/pellet.png',
  'chènevis':                '/techniques/chenevis.png',
  'chenevis':                '/techniques/chenevis.png',
  'ver de terre':            '/techniques/ver-terre.png',
  'ver de vase':             '/techniques/ver-vase.png',
  'ver':                     '/techniques/ver.png',
  'pâte':                    '/techniques/pate-truite.png',
  'pate':                    '/techniques/pate-truite.png',
  ...
  'canne à coup':            '/techniques/canne-coup.png',
  'canne a coup':            '/techniques/canne-coup.png',
  'canne a cou':             '/techniques/canne-coup.png',
}
